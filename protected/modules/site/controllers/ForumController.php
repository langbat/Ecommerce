				...
				if( $newPost->save() )
				{
					...
					if( $topicSubscribtions )
					{
						foreach( $topicSubscribtions as $sub )
						{
                            ...
                            $template = EmailTemplates::getAlias('forum-mail');
                            $email_template = new EmailTemplates;
							$message = Yii::t('forum', $email_template->email_content, 
																		  array( 
                            ...
                            Utils::sendMail(Yii::app()->params['emailout'], $sub->email,  $email_template->email_subject, $message);
