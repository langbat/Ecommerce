<div class="content-block">
        <div class="wrapper_profile">
            <div class="slider-box purple-grid">
                ...
                <?php } else { ?>
                    <div class="title" style="margin-bottom: 20px;"><h5><?php echo Yii::t('global','Create Blog Shop');?></h5></div>
                   <div class="create_link"><a class="isw-back tipb" style="margin-top: -50px;" href="/blogshop/index" title="<?php echo Yii::t('global','Back') ?>"></a> </div>
