...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'remaining_date'); ?>
		<?php echo $form->textField($model,'remaining_date'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'delivery_way'); ?>
		<?php echo $form->textField($model,'delivery_way'); ?>
	</div>
