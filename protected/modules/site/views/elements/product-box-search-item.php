...
<div class="wrapper-active"<?php echo ($index)%4==0? 'style="clear: both;"':''?>>
    <div class="span2 product-content fix-content  <?php echo ($index%4 == 3)?' last-column':''?>">
        <div class="product-image">
            <a href="/products/detail/<?php echo $data->id?>"><img class="product" <?php echo 'src="/uploads/product/'.$data->image.'"'?> title="<?php echo $data->name?>" alt="<?php echo $data->name?>" /></a>
        </div>
        <p class="fix-title"><a href="/products/detail/<?php echo $data->id?>" title="<?php echo $data->name?>"><?php echo strlen($data->name)>20?substr($data->name, 0, 20)."...":$data->name?></a></p>
                 ...
                 <span class="rating_new_shop_label">
                   <?php
                      $this->widget('ext.dzRaty.DzRaty', array(
                            'name' => 'my_rating_field_label_product_tosello_'.$data->id,
