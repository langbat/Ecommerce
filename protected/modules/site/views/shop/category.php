<div class="content">
    <?php if((isset($productcategotyshop)) && ($productcategotyshop->itemCount) > 0){?>
    ...
    <?php $this->widget('zii.widgets.CListView', array(
    	'dataProvider'=>$productcategotyshop,
    	'itemView'=>'../elements/product-shop-box-item',
        'id'=>'item',
        'afterAjaxUpdate' => 'updateRatingCate',
        ));
     ?>
     </div>
    <?php }else{ ?>
...
<script>
  function updateRatingCate() {
        <?php 
          $models = ProductsShop::model()->findAllByAttributes(array('shop_id' => $this->membershop->id));
