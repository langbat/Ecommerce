<div class="content">
<?php if((isset($productshopbyprice)) && ($productshopbyprice->itemCount) > 0) { ?>
    ...
    <?php 
    	...
    	'dataProvider'=>$productshopbyprice,
...
<script>
  function updateRating(id, data) {
      <?php 
          ...
          $productshopbyprice = new CActiveDataProvider('ProductsShop', array(
            'criteria'=>$criteria,
            'pagination'=>array(
                'pageSize'=>$totalProduct,
            ),
          ));
          $results = $productshopbyprice->getData();
