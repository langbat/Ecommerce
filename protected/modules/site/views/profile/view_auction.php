...
<?php }else{ ?>
    <div class="title">
	    <h5 class="left-10"><?php echo Yii::t('global', ' My Viewed Auctions')?></h5>
    </div>
	<div class="product-wrapper show-grid hide-summary">
		<?php $this->widget('zii.widgets.CListView', array(
			'dataProvider'=>$auctionsview->getMyViewedUpcomingAuction(Yii::app()->user->id),
			'itemView'=>'../elements/my-auction-viewed',
		)); ?>
