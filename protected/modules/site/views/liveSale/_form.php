...
error_reporting(0);
$NameShops = MemberShop::model()->getNameShopById( isset($model->shop_id)?$model->shop_id:$shop_id );
    ...
    <div class="modal-body fix-new-scrollBox"> 
      <div id="list-product-on-shop">
       <ul id="ul-list-product">
             <?php
                 $Products = ProductsShop::model()->getProductsShopByNotExitst( isset($model->shop_id)?$model->shop_id:$shop_id, isset($model->list_product_id)?$model->list_product_id:0 );
                ...
                <tbody id="content-product-add">
                       <?php 
                        if(isset($model->list_product_id)){
                             $productexists = ProductsShop::model()->getProductsShopExists( isset($model->shop_id)?$model->shop_id:$shop_id, isset($model->list_product_id)?$model->list_product_id:0 );
                            ...
                            <td width='386px'><a href='/productShopManager/view?id=<?php echo $Productexist['id']; ?>'> <?php echo $Productexist['name']; ?> </a></td>
           ...
           $("#choice-product-new").click(function() {
                $("input[type=checkbox]:checked").each(function() {
                     ...
                     if( typeof(valproduct[2]) !== 'undefined' ){
                            ...
                            "<td width='390px'><a href='/productShopManager/view?id=" + valproduct[0] + "'>" + valproduct[3] + "</a></td>" +
...
$("#LiveSale_media2").filestyle({buttonText: "<?php echo Yii::t('global','Choose file') ?>"});</script>