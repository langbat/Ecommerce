...
class MessagesShopController extends AdminBaseController {
    public function init()
	{
		parent::init();
		
		$this->breadcrumbs[ Yii::t('global', 'Messages Shops') ] = array('messagesShop/index');
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['messagesShop']))
			$model->attributes=$_GET['messagesShop'];
