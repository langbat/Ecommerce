 ...
 * custom pages model
 */
class CustomSupportPages extends CActiveRecord
{		
	/**
	 * @return object
	 */
    ...
    function languageButton($lang){
        ...
        if ($model){
            return '<a href="'.Yii::app()->createUrl('admin/customsupportpages/update', array('id' => $model->id)).'" class="tipb" data-original-title="'.Yii::t('global', 'Edit').'">
                <img src="/assets/images/update.png" />
            </a><a href="'.Yii::app()->createUrl('admin/customsupportpages/view', array('id' => $model->id)).'" class="tipb" data-original-title="'.Yii::t('global', 'View').'">
                <img src="/assets/images/view.png" />
            </a>';
        }
        else{
            return '<a href="'.Yii::app()->createUrl('admin/customsupportpages/create', array('alias' => $this->alias, 'language'=> $lang)).'" class="tipb" data-original-title="'.Yii::t('global', 'Add').'">
                <i class="icon-plus"></i>
            </a>';
        }
    }
