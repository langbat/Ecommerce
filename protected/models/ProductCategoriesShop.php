...
/**
 * This is the model class for table "product_categories_shop".
 *
 * The followings are the available columns in table 'product_categories_shop':
 * @property integer $id
 * @property integer $product_id
 * @property integer $category_id
 *
 * The followings are the available model relations:
 * @property ProductsShop $product
 * @property CategoriesShop $category
 */
class ProductCategoriesShop extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProductCategoriesShop the static model class
	 */
     public $categoryshop ;
	...
	{
		return 'product_categories_shop';
	}
	...
	public function relations()
	{
		...
		return array(
			'product' => array(self::BELONGS_TO, 'ProductsShop', 'product_id'),
            'category' => array(self::BELONGS_TO, 'CategoriesShop', 'category_id'),
		);
	}
    ...
    public function getCategoryShopByShopId($shop_id){
        ...
        WHERE products_shop.shop_id = ".$shop_id. " GROUP BY categories_shop.id";
        return Yii::app()->db->createCommand($sql)->queryAll();
    }
    public function getProductOfCategory($arrayProduct,$idCategory){
        $sql = "SELECT * FROM product_categories_shop
