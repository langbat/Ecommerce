 ...
 *
 * The followings are the available columns in table 'coupon_codes':
 * @property integer $id
...
class CouponCodes extends CActiveRecord
{
	 ...
	 * @return CouponCodes the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('coupon_id, user_id, order_id', 'numerical', 'integerOnly'=>true),
			array('code', 'length', 'max'=>12),
			array('used_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, coupon_id, code, user_id, used_date, order_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => Yii::t('global', 'ID'),
			'coupon_id' => Yii::t('global', 'Coupon'),
			'code' => Yii::t('global', 'Code'),
			'user_id' => Yii::t('global', 'User'),
			'used_date' => Yii::t('global', 'Used Date'),
